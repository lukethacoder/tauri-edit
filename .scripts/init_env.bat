...
set "TAURI_DIST_DIR=%~1examples\tauri\communication\dist"
set "TAURI_DIR=%~1examples\tauri\communication\src-tauri"
REM set "TAURI_DIST_DIR=%~1tauri\examples\communication\dist"
REM set "TAURI_DIR=%~1tauri\examples\communication\src-tauri"
